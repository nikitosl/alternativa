...
function edge_painting(mas, i,k, col) //mas - Ï‡ÒÒË‚ Â·Â ÙÓÏ‡Ú‡: [q1{num,x,y}, -ÔÂ‚‡ˇ ‚Â¯ËÌ‡
    //                             q2{num,x,y}, -‚ÚÓ‡ˇ ‚Â¯ËÌ‡
    //                             weight,      -‚ÂÒ Â·‡
    //                             print];      -Ì‡ËÒÓ‚‡ÌÓ ÎË Â·Ó
    //                                             (1/0)
{
    if (!mas[i])
        return null;
    var x1, y1, x2, y2,f;
    var radius = 5;
    //  var col = '#066';               //ÌÂ‚˚·‡Ì˚Â ÎËÌËË
    var col0 = 'rgba(0,6,6,0.04)';  //ÌÂ‚˚·‡Ì˚Â ÔˇÏÓÛ„ÓÎ¸ÌËÍË
    var col1 = 'rgba(0,9,9,0.2)';   //ÔÓ‰Ò‚Â˜ÂÌ˚Â ÔˇÏÓÛ„ÓÎ¸ÌËÍË
    var col2 = '#600';//‚˚·‡Ì˚Â ÎËÌËË
    var kos = [];
    var wei = [];
    var center = [];
